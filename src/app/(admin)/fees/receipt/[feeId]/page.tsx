  ...
  return (
    <html>
      <head>
        ...
        <title>Receipt — {fee.member_name}</title>
        <style>{`
      ...
      <body>
        ...
        <div className="no-print" style={{ textAlign: 'center', padding: '16px 0', background: '#f8fafc' }}>
          <button
        ...
        <div className="page">
          ...
          <div className="header">
            ...
            <div className="receipt-badge">
              ...
              <div className="ref" style={{ marginTop: 6 }}>
                <span
                  className={`status-badge status-${fee.status}`}
                >
          ...
          <div className="amount-section">
            <div className="amount-row">
              <span className="label" style={{ color: '#64748b' }}>Gross Amount</span>
              <span className="value">{formatCurrency(fee.total_amount)}</span>
            </div>
            {fee.discount > 0 && (
              <div className="amount-row">
                <span className="label" style={{ color: '#64748b' }}>Discount</span>
                <span className="value" style={{ color: '#16a34a' }}>− {formatCurrency(fee.discount)}</span>
              </div>
            )}
            <div className="amount-row">
              <span className="label" style={{ color: '#64748b' }}>Net Payable</span>
              <span className="value">{formatCurrency(fee.net_amount)}</span>
            </div>
            <div className="amount-row">
              <span className="label" style={{ color: '#64748b' }}>Amount Paid</span>
              <span className="value" style={{ color: '#16a34a' }}>{formatCurrency(fee.paid_amount)}</span>
            </div>
